...
CodeMirror.defineSimpleMode("xenoncode", {
	...
	start: [
	  ...
	  {regex: /function|storage|array|var|const|include|return|if|foreach|while|else|elseif|init|input|timer|output|repeat|frequency|interval|break|loop/, token: "keyword"},
