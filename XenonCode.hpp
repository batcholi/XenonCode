...
#pragma region Compiler
	...
	inline static const std::vector<BuiltInFunctionDef>& GetBuiltInFunctions() {
		static const std::vector<BuiltInFunctionDef> functions = {
			// Math
			{"floor", "($value:number):number", RAM_VAR_NUMERIC, CALL_EXPRESSION | CALL_TRAILING, APPLIES_NUMBER},
			{"ceil", "($value:number):number", RAM_VAR_NUMERIC, CALL_EXPRESSION | CALL_TRAILING, APPLIES_NUMBER},
			{"round", "($value:number):number", RAM_VAR_NUMERIC, CALL_EXPRESSION | CALL_TRAILING, APPLIES_NUMBER},
			{"sin", "($value:number):number", RAM_VAR_NUMERIC, CALL_EXPRESSION | CALL_TRAILING, APPLIES_NUMBER},
			{"cos", "($value:number):number", RAM_VAR_NUMERIC, CALL_EXPRESSION | CALL_TRAILING, APPLIES_NUMBER},
			{"tan", "($value:number):number", RAM_VAR_NUMERIC, CALL_EXPRESSION | CALL_TRAILING, APPLIES_NUMBER},
			{"asin", "($value:number):number", RAM_VAR_NUMERIC, CALL_EXPRESSION | CALL_TRAILING, APPLIES_NUMBER},
			{"acos", "($value:number):number", RAM_VAR_NUMERIC, CALL_EXPRESSION | CALL_TRAILING, APPLIES_NUMBER},
			{"atan", "($y:number [, $x:number]):number", RAM_VAR_NUMERIC, CALL_EXPRESSION | CALL_TRAILING, APPLIES_NUMBER},
			{"abs", "($value:number):number", RAM_VAR_NUMERIC, CALL_EXPRESSION | CALL_TRAILING, APPLIES_NUMBER},
			{"fract", "($value:number):number", RAM_VAR_NUMERIC, CALL_EXPRESSION | CALL_TRAILING, APPLIES_NUMBER},
			{"sqrt", "($value:number):number", RAM_VAR_NUMERIC, CALL_EXPRESSION | CALL_TRAILING, APPLIES_NUMBER},
			...
			{"min", "($a:number, $b:number, ...):number", RAM_VAR_NUMERIC, CALL_EXPRESSION | CALL_TRAILING, APPLIES_NUMBER | APPLIES_ARRAY},
			{"max", "($a:number, $b:number, ...):number", RAM_VAR_NUMERIC, CALL_EXPRESSION | CALL_TRAILING, APPLIES_NUMBER | APPLIES_ARRAY},
			// Aggregation
			...
			// Binary arithmetic
			{"add", "($a:number, $b:number):number", RAM_VAR_NUMERIC, CALL_EXPRESSION | CALL_TRAILING, APPLIES_NUMBER},
			{"sub", "($a:number, $b:number):number", RAM_VAR_NUMERIC, CALL_EXPRESSION | CALL_TRAILING, APPLIES_NUMBER},
			{"mul", "($a:number, $b:number):number", RAM_VAR_NUMERIC, CALL_EXPRESSION | CALL_TRAILING, APPLIES_NUMBER},
			{"div", "($a:number, $b:number):number", RAM_VAR_NUMERIC, CALL_EXPRESSION | CALL_TRAILING, APPLIES_NUMBER},
			...
			{"clear", "($array)", CODE_VOID, CALL_TRAILING, APPLIES_ARRAY},
			{"append", "($array, $value, ...)", CODE_VOID, CALL_TRAILING, APPLIES_ARRAY},
			{"pop", "($array)", CODE_VOID, CALL_TRAILING, APPLIES_ARRAY},
			{"insert", "($array, $index:number, $value, ...)", CODE_VOID, CALL_TRAILING, APPLIES_ARRAY},
			{"erase", "($array, $index:number [, $end:number])", CODE_VOID, CALL_TRAILING, APPLIES_ARRAY},
			{"fill", "($array, $quantity:number, $value)", CODE_VOID, CALL_TRAILING, APPLIES_ARRAY},
			{"from", "($array, $source [, $separator:text])", CODE_VOID, CALL_TRAILING, APPLIES_ARRAY},
			{"sort", "($array)", CODE_VOID, CALL_TRAILING, APPLIES_ARRAY},
			{"sortd", "($array)", CODE_VOID, CALL_TRAILING, APPLIES_ARRAY},
			// Text
			...
			{"upper", "($text:text):text", RAM_VAR_TEXT, CALL_EXPRESSION | CALL_TRAILING, APPLIES_TEXT},
			{"lower", "($text:text):text", RAM_VAR_TEXT, CALL_EXPRESSION | CALL_TRAILING, APPLIES_TEXT},
			{"hash", "($text:text):number", RAM_VAR_NUMERIC, CALL_EXPRESSION | CALL_TRAILING, APPLIES_TEXT},
			{"isnumeric", "($text:text):number", RAM_VAR_NUMERIC, CALL_EXPRESSION | CALL_TRAILING, APPLIES_TEXT},
			...
			{"length", "($v):number", RAM_VAR_NUMERIC, CALL_EXPRESSION, APPLIES_VECTOR | APPLIES_MATRIX},
			{"distance", "($a, $b):number", RAM_VAR_NUMERIC, CALL_EXPRESSION, APPLIES_VECTOR | APPLIES_MATRIX},
			{"dot", "($a, $b):number", RAM_VAR_NUMERIC, CALL_EXPRESSION, APPLIES_VECTOR | APPLIES_MATRIX},
			{"angle", "($a, $b):number", RAM_VAR_NUMERIC, CALL_EXPRESSION, APPLIES_VECTOR | APPLIES_MATRIX},
			...
			{"normalize", "($v)", CODE_VOID, CALL_EXPRESSION | CALL_TRAILING, APPLIES_VECTOR | APPLIES_MATRIX},
			{"transpose", "($m)", CODE_VOID, CALL_EXPRESSION | CALL_TRAILING, APPLIES_MATRIX},
			{"inverse", "($m)", CODE_VOID, CALL_EXPRESSION | CALL_TRAILING, APPLIES_MATRIX},
		};
		return functions;
	}
